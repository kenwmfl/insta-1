...
import './Navbar.css';
import { MdHomeFilled, MdOutlineExplore, MdOutlineAddBox, MdOutlineMenu, MdChatBubbleOutline } from 'react-icons/md';
    ...
    <div className="navbar-container" style={{width:isSearch && '80px'}}>
      <div className="navbar-wrapper">
        ...
        <div className="nav-menu-wrapper">
          ...
          <div className='explore-menu-wrapper menu-wrapper'>
            <NavLink to='/message' className={({ isActive }) => isActive ? 'active-link align-center' : 'align-center'}>
              <div className="icon absolute-center">
                <MdChatBubbleOutline style={{ width: '100%', height: '100%' }} />
              </div>
              <div className={`menu-title ${isSearch && 'hide-content'}`} >
                Message
              </div>
